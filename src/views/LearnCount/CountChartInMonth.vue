  ...
  <div>
    <div style="float:left;">
      <div style="position:relative;float:left;margin-bottom:0px;">
        ...
        <span style="margin-left:170px;">共学习{{totalTimes}}次</span>
        <span style="margin-left:170px;">{{total}}小时</span>
      </div>
      <div id="learnMonthCountId" style="float:left;width:1310px;height:220px;margin-top:-5px;"></div>
    </div>
  </div>
</template>
<script>
